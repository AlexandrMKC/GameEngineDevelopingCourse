add_library("AkAudioInputSource" STATIC
  "${CMAKE_CURRENT_LIST_DIR}/../AkFXSrcAudioInput.cpp"
  "${CMAKE_CURRENT_LIST_DIR}/../AkFXSrcAudioInputParams.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkAudioInputSource" PROPERTIES
    OUTPUT_NAME "AkAudioInputSource"
  ...
  target_include_directories("AkAudioInputSource" PRIVATE
  ...
  target_compile_definitions("AkAudioInputSource" PRIVATE
    "_DEBUG"
    "AUDIOKINETIC"
  )
  target_compile_options("AkAudioInputSource" PRIVATE "-ffast-math")
  target_compile_options("AkAudioInputSource" PRIVATE "-fPIC")
  target_compile_options("AkAudioInputSource" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkAudioInputSource" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkAudioInputSource" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkAudioInputSource" PRIVATE "-fno-rtti")
  target_compile_options("AkAudioInputSource" PRIVATE "-fno-exceptions")
  target_compile_options("AkAudioInputSource" PRIVATE "-fno-omit-frame-pointer")
  if (MSVC)
    target_compile_options("AkAudioInputSource" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkAudioInputSource" PRIVATE "-fno-rtti")
  target_compile_options("AkAudioInputSource" PRIVATE "-fno-exceptions")
  target_compile_options("AkAudioInputSource" PRIVATE "-ffunction-sections")
  target_compile_options("AkAudioInputSource" PRIVATE "-fdata-sections")
  target_compile_options("AkAudioInputSource" PRIVATE "-fno-omit-frame-pointer")
  if (MSVC)
    target_compile_options("AkAudioInputSource" PRIVATE
      $<$<COMPILE_LANGUAGE:C>:/WX>
