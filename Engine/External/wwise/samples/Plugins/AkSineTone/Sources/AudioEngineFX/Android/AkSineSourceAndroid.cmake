add_library("AkSineSource" STATIC
  "${CMAKE_CURRENT_LIST_DIR}/../../../../../DSP/AkSineOsc.cpp"
  "${CMAKE_CURRENT_LIST_DIR}/../AkFXSrcSine.cpp"
  "${CMAKE_CURRENT_LIST_DIR}/../AkFXSrcSineParams.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkSineSource" PROPERTIES
    OUTPUT_NAME "AkSineSource"
  ...
  target_include_directories("AkSineSource" PRIVATE
  ...
  target_compile_definitions("AkSineSource" PRIVATE
    "_DEBUG"
  )
  target_compile_options("AkSineSource" PRIVATE "-ffast-math")
  target_compile_options("AkSineSource" PRIVATE "-fPIC")
  target_compile_options("AkSineSource" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkSineSource" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkSineSource" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkSineSource" PRIVATE "-fno-rtti")
  target_compile_options("AkSineSource" PRIVATE "-fno-exceptions")
  target_compile_options("AkSineSource" PRIVATE "-fno-omit-frame-pointer")
  if (MSVC)
    target_compile_options("AkSineSource" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkSineSource" PRIVATE "-fno-rtti")
  target_compile_options("AkSineSource" PRIVATE "-fno-exceptions")
  target_compile_options("AkSineSource" PRIVATE "-ffunction-sections")
  target_compile_options("AkSineSource" PRIVATE "-fdata-sections")
  target_compile_options("AkSineSource" PRIVATE "-fno-omit-frame-pointer")
  if (MSVC)
    target_compile_options("AkSineSource" PRIVATE
      $<$<COMPILE_LANGUAGE:C>:/WX>
