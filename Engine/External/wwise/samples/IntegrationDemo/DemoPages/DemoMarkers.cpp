...
void DemoMarkers::MarkersCallback( AkCallbackType in_eType, AkEventCallbackInfo* in_pEventInfo, void* in_pCallbackInfo, void* in_pCookie )
{
	DemoMarkers* pPage = (DemoMarkers*)in_pCookie;
	if ( in_eType == AK_Marker )
	{
		AkMarkerCallbackInfo* pMarkerCallbackInfo = (AkMarkerCallbackInfo*)in_pCallbackInfo;
		pPage->m_strCurrentLine.assign( pMarkerCallbackInfo->strLabel, pMarkerCallbackInfo->uLabelSize );
	}
