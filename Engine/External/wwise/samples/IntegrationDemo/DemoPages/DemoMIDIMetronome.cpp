...
void DemoMIDIMetronome::PostMIDIEvents( AkUInt32 in_uSampleOffset )
{
	...
	noteOn.midiEvent.byType = AK_MIDI_EVENT_TYPE_NOTE_ON;
	noteOn.midiEvent.byChan = 0;
	noteOn.midiEvent.NoteOnOff.byNote = byNote;
	noteOn.midiEvent.NoteOnOff.byVelocity = 72;
	noteOn.uOffset = in_uSampleOffset;

	// Note-off
	AkMIDIPost& noteOff = aPosts[1];
	noteOff.midiEvent.byType = AK_MIDI_EVENT_TYPE_NOTE_OFF;
	noteOff.midiEvent.byChan = 0;
	noteOff.midiEvent.NoteOnOff.byNote = byNote;
	noteOff.midiEvent.NoteOnOff.byVelocity = 0;
