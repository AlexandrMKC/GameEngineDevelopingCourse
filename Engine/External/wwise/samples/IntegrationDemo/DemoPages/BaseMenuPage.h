...
private:
	...
	/// Delegate function for the "Command Buffer" button.
	void OpenCommandBufferDemoPage(void* in_pSender, ControlEvent* in_pEvent);
	...
	/// Delegate function for the "Partner Plug-ins Demos" button.
	void OpenPartnerPluginsMenuPage(void* in_pSender, ControlEvent* in_pEvent);

#ifdef INTEGRATIONDEMO_APP_LIFECYCLE
	void OpenAppLifecycleDemoPage( void*, ControlEvent* in_pEvent );
#endif

	/// Delegate function for the "Channels" button.
	void OpenChannelsDemoPage(void* in_pSender, ControlEvent* in_pEvent);
