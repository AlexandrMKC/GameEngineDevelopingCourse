...
private:
	...
	// Select another test to play
	void Test_Selected(void* in_pSender, ControlEvent* in_pControlEvent);
	...
	typedef void (DemoDynamicDialogue::*TestCallbackFunc)();

	/// Pointer to the next testing function to run. Null when tests are stopped.
	TestCallbackFunc m_pNextFunction;
	...
	// Pointers to the start of test functions
	TestCallbackFunc m_pTestFunctions[NUM_TESTS];
	...
	static void Set14_Callback( AkCallbackType in_eType, AkEventCallbackInfo* in_pEventInfo, void* in_pCallbackInfo, void* in_pCookie );
	...
	static void Set15_Callback( AkCallbackType in_eType, AkEventCallbackInfo* in_pEventInfo, void* in_pCallbackInfo, void* in_pCookie );
	...
	static void Set16_Callback( AkCallbackType in_eType, AkEventCallbackInfo* in_pEventInfo, void* in_pCallbackInfo, void* in_pCookie );
	...
	static void Set17_Callback( AkCallbackType in_eType, AkEventCallbackInfo* in_pEventInfo, void* in_pCallbackInfo, void* in_pCookie );
	...
	//////////////
	//	Test Set 19 - Callback-based dynamic sequences
	//////////////
	void Set19_1_StartPlayback();
	void Set19_2_ResumePlayback();
	static void Set19_Callback(AkCallbackType in_eType, AkEventCallbackInfo* in_pEventInfo, void* out_pCallbackInfo, void* in_pCookie);
	int mSet19_State;
	...
	//	Test Set 20 - Seeking
	//////////////
	void Set20_1_StartPlayback();
	void Set20_2_SeekRelative();
	void Set20_2_SeekAbsolute();
};
