...
void DemoMusicCallbacks::MusicCallback( AkCallbackType in_eType, AkEventCallbackInfo* in_pEventInfo, void* in_pCallbackInfo, void* in_pCookie )
{
	DemoMusicCallbacks* pPage = (DemoMusicCallbacks*)in_pCookie;
...
void DemoMusicPlaylistCallbacks::MusicCallback( AkCallbackType in_eType, AkEventCallbackInfo* in_pEventInfo, void* in_pCallbackInfo, void* in_pCookie )
{
	DemoMusicPlaylistCallbacks* pPage = (DemoMusicPlaylistCallbacks*)in_pCookie;
...
void DemoMIDICallbacks::MusicCallback( AkCallbackType in_eType, AkEventCallbackInfo* in_pEventInfo, void* in_pCallbackInfo, void* in_pCookie )
{
	DemoMIDICallbacks* pPage = (DemoMIDICallbacks*)in_pCookie;
