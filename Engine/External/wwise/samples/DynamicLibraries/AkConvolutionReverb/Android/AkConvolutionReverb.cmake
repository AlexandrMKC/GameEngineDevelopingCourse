add_library("AkConvolutionReverb" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkConvolutionReverb" PROPERTIES
    OUTPUT_NAME "AkConvolutionReverb"
  ...
  target_include_directories("AkConvolutionReverb" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkConvolutionReverb" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkConvolutionReverb" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkConvolutionReverb"
    "AkConvolutionReverbFX"
  )
  target_compile_options("AkConvolutionReverb" PRIVATE "-fPIC")
  target_compile_options("AkConvolutionReverb" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkConvolutionReverb" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkConvolutionReverb" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkConvolutionReverb" PRIVATE "-fno-rtti")
  target_compile_options("AkConvolutionReverb" PRIVATE "-fno-exceptions")
  target_compile_options("AkConvolutionReverb" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkConvolutionReverb" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkConvolutionReverb" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkConvolutionReverb" PRIVATE "-fno-rtti")
  target_compile_options("AkConvolutionReverb" PRIVATE "-fno-exceptions")
  target_compile_options("AkConvolutionReverb" PRIVATE "-ffunction-sections")
  target_compile_options("AkConvolutionReverb" PRIVATE "-fdata-sections")
  target_compile_options("AkConvolutionReverb" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkConvolutionReverb" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkConvolutionReverb" PRIVATE
