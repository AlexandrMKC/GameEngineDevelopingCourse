add_library("AkParametricEQ" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkParametricEQ" PROPERTIES
    OUTPUT_NAME "AkParametricEQ"
  ...
  target_include_directories("AkParametricEQ" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkParametricEQ" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkParametricEQ" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkParametricEQ"
    "AkParametricEQFX"
  )
  target_compile_options("AkParametricEQ" PRIVATE "-fPIC")
  target_compile_options("AkParametricEQ" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkParametricEQ" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkParametricEQ" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkParametricEQ" PRIVATE "-fno-rtti")
  target_compile_options("AkParametricEQ" PRIVATE "-fno-exceptions")
  target_compile_options("AkParametricEQ" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkParametricEQ" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkParametricEQ" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkParametricEQ" PRIVATE "-fno-rtti")
  target_compile_options("AkParametricEQ" PRIVATE "-fno-exceptions")
  target_compile_options("AkParametricEQ" PRIVATE "-ffunction-sections")
  target_compile_options("AkParametricEQ" PRIVATE "-fdata-sections")
  target_compile_options("AkParametricEQ" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkParametricEQ" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkParametricEQ" PRIVATE
