add_library("AkReflect" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkReflect" PROPERTIES
    OUTPUT_NAME "AkReflect"
  ...
  target_include_directories("AkReflect" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkReflect" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkReflect" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkReflect"
    "AkReflectFX"
  )
  target_compile_options("AkReflect" PRIVATE "-fPIC")
  target_compile_options("AkReflect" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkReflect" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkReflect" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkReflect" PRIVATE "-fno-rtti")
  target_compile_options("AkReflect" PRIVATE "-fno-exceptions")
  target_compile_options("AkReflect" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkReflect" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkReflect" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkReflect" PRIVATE "-fno-rtti")
  target_compile_options("AkReflect" PRIVATE "-fno-exceptions")
  target_compile_options("AkReflect" PRIVATE "-ffunction-sections")
  target_compile_options("AkReflect" PRIVATE "-fdata-sections")
  target_compile_options("AkReflect" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkReflect" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkReflect" PRIVATE
