add_library("AkTimeStretch" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkTimeStretch" PROPERTIES
    OUTPUT_NAME "AkTimeStretch"
  ...
  target_include_directories("AkTimeStretch" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkTimeStretch" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkTimeStretch" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkTimeStretch"
    "AkTimeStretchFX"
  )
  target_compile_options("AkTimeStretch" PRIVATE "-fPIC")
  target_compile_options("AkTimeStretch" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkTimeStretch" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkTimeStretch" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkTimeStretch" PRIVATE "-fno-rtti")
  target_compile_options("AkTimeStretch" PRIVATE "-fno-exceptions")
  target_compile_options("AkTimeStretch" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkTimeStretch" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkTimeStretch" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkTimeStretch" PRIVATE "-fno-rtti")
  target_compile_options("AkTimeStretch" PRIVATE "-fno-exceptions")
  target_compile_options("AkTimeStretch" PRIVATE "-ffunction-sections")
  target_compile_options("AkTimeStretch" PRIVATE "-fdata-sections")
  target_compile_options("AkTimeStretch" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkTimeStretch" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkTimeStretch" PRIVATE
