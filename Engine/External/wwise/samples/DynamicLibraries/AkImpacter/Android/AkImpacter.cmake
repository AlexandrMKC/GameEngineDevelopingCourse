add_library("AkImpacter" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkImpacter" PROPERTIES
    OUTPUT_NAME "AkImpacter"
  ...
  target_include_directories("AkImpacter" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkImpacter" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkImpacter" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkImpacter"
    "AkImpacterSource"
  )
  target_compile_options("AkImpacter" PRIVATE "-fPIC")
  target_compile_options("AkImpacter" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkImpacter" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkImpacter" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkImpacter" PRIVATE "-fno-rtti")
  target_compile_options("AkImpacter" PRIVATE "-fno-exceptions")
  target_compile_options("AkImpacter" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkImpacter" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkImpacter" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkImpacter" PRIVATE "-fno-rtti")
  target_compile_options("AkImpacter" PRIVATE "-fno-exceptions")
  target_compile_options("AkImpacter" PRIVATE "-ffunction-sections")
  target_compile_options("AkImpacter" PRIVATE "-fdata-sections")
  target_compile_options("AkImpacter" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkImpacter" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkImpacter" PRIVATE
