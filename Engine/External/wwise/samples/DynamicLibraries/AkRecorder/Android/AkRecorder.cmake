add_library("AkRecorder" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkRecorder" PROPERTIES
    OUTPUT_NAME "AkRecorder"
  ...
  target_include_directories("AkRecorder" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkRecorder" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkRecorder" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkRecorder"
    "AkRecorderFX"
  )
  target_compile_options("AkRecorder" PRIVATE "-fPIC")
  target_compile_options("AkRecorder" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkRecorder" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkRecorder" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkRecorder" PRIVATE "-fno-rtti")
  target_compile_options("AkRecorder" PRIVATE "-fno-exceptions")
  target_compile_options("AkRecorder" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkRecorder" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkRecorder" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkRecorder" PRIVATE "-fno-rtti")
  target_compile_options("AkRecorder" PRIVATE "-fno-exceptions")
  target_compile_options("AkRecorder" PRIVATE "-ffunction-sections")
  target_compile_options("AkRecorder" PRIVATE "-fdata-sections")
  target_compile_options("AkRecorder" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkRecorder" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkRecorder" PRIVATE
