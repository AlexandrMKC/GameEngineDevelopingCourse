add_library("AkHarmonizer" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkHarmonizer" PROPERTIES
    OUTPUT_NAME "AkHarmonizer"
  ...
  target_include_directories("AkHarmonizer" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkHarmonizer" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkHarmonizer" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkHarmonizer"
    "AkHarmonizerFX"
  )
  target_compile_options("AkHarmonizer" PRIVATE "-fPIC")
  target_compile_options("AkHarmonizer" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkHarmonizer" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkHarmonizer" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkHarmonizer" PRIVATE "-fno-rtti")
  target_compile_options("AkHarmonizer" PRIVATE "-fno-exceptions")
  target_compile_options("AkHarmonizer" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkHarmonizer" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkHarmonizer" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkHarmonizer" PRIVATE "-fno-rtti")
  target_compile_options("AkHarmonizer" PRIVATE "-fno-exceptions")
  target_compile_options("AkHarmonizer" PRIVATE "-ffunction-sections")
  target_compile_options("AkHarmonizer" PRIVATE "-fdata-sections")
  target_compile_options("AkHarmonizer" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkHarmonizer" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkHarmonizer" PRIVATE
