add_library("AkSidechain" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkSidechain" PROPERTIES
    OUTPUT_NAME "AkSidechain"
  ...
  target_include_directories("AkSidechain" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkSidechain" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkSidechain" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkSidechain"
    "AkSidechainFX"
  )
  target_compile_options("AkSidechain" PRIVATE "-fPIC")
  target_compile_options("AkSidechain" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkSidechain" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkSidechain" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkSidechain" PRIVATE "-fno-rtti")
  target_compile_options("AkSidechain" PRIVATE "-fno-exceptions")
  target_compile_options("AkSidechain" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkSidechain" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkSidechain" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkSidechain" PRIVATE "-fno-rtti")
  target_compile_options("AkSidechain" PRIVATE "-fno-exceptions")
  target_compile_options("AkSidechain" PRIVATE "-ffunction-sections")
  target_compile_options("AkSidechain" PRIVATE "-fdata-sections")
  target_compile_options("AkSidechain" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkSidechain" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkSidechain" PRIVATE
