add_library("AkRecorderADM" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkRecorderADM" PROPERTIES
    OUTPUT_NAME "AkRecorderADM"
  ...
  target_include_directories("AkRecorderADM" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkRecorderADM" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkRecorderADM" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkRecorderADM"
    "AkRecorderADMFX"
  )
  target_compile_options("AkRecorderADM" PRIVATE "-fPIC")
  target_compile_options("AkRecorderADM" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkRecorderADM" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkRecorderADM" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkRecorderADM" PRIVATE "-fno-rtti")
  target_compile_options("AkRecorderADM" PRIVATE "-fno-exceptions")
  target_compile_options("AkRecorderADM" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkRecorderADM" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkRecorderADM" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkRecorderADM" PRIVATE "-fno-rtti")
  target_compile_options("AkRecorderADM" PRIVATE "-fno-exceptions")
  target_compile_options("AkRecorderADM" PRIVATE "-ffunction-sections")
  target_compile_options("AkRecorderADM" PRIVATE "-fdata-sections")
  target_compile_options("AkRecorderADM" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkRecorderADM" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkRecorderADM" PRIVATE
