...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  ...
  target_include_directories("AkGain" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkGain" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkGain" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkGain"
    "AkGainFX"
  )
  target_compile_options("AkGain" PRIVATE "-fPIC")
  target_compile_options("AkGain" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkGain" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkGain" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkGain" PRIVATE "-fno-rtti")
  target_compile_options("AkGain" PRIVATE "-fno-exceptions")
  target_compile_options("AkGain" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkGain" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkGain" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkGain" PRIVATE "-fno-rtti")
  target_compile_options("AkGain" PRIVATE "-fno-exceptions")
  target_compile_options("AkGain" PRIVATE "-ffunction-sections")
  target_compile_options("AkGain" PRIVATE "-fdata-sections")
  target_compile_options("AkGain" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkGain" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkGain" PRIVATE
