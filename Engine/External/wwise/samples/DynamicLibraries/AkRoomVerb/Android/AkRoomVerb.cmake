add_library("AkRoomVerb" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkRoomVerb" PROPERTIES
    OUTPUT_NAME "AkRoomVerb"
  ...
  target_include_directories("AkRoomVerb" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkRoomVerb" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkRoomVerb" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkRoomVerb"
    "AkRoomVerbFX"
  )
  target_compile_options("AkRoomVerb" PRIVATE "-fPIC")
  target_compile_options("AkRoomVerb" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkRoomVerb" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkRoomVerb" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkRoomVerb" PRIVATE "-fno-rtti")
  target_compile_options("AkRoomVerb" PRIVATE "-fno-exceptions")
  target_compile_options("AkRoomVerb" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkRoomVerb" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkRoomVerb" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkRoomVerb" PRIVATE "-fno-rtti")
  target_compile_options("AkRoomVerb" PRIVATE "-fno-exceptions")
  target_compile_options("AkRoomVerb" PRIVATE "-ffunction-sections")
  target_compile_options("AkRoomVerb" PRIVATE "-fdata-sections")
  target_compile_options("AkRoomVerb" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkRoomVerb" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkRoomVerb" PRIVATE
