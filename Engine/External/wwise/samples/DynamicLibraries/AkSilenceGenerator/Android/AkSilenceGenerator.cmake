add_library("AkSilenceGenerator" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkSilenceGenerator" PROPERTIES
    OUTPUT_NAME "AkSilenceGenerator"
  ...
  target_include_directories("AkSilenceGenerator" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkSilenceGenerator" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkSilenceGenerator" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkSilenceGenerator"
    "AkSilenceSource"
  )
  target_compile_options("AkSilenceGenerator" PRIVATE "-fPIC")
  target_compile_options("AkSilenceGenerator" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkSilenceGenerator" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkSilenceGenerator" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkSilenceGenerator" PRIVATE "-fno-rtti")
  target_compile_options("AkSilenceGenerator" PRIVATE "-fno-exceptions")
  target_compile_options("AkSilenceGenerator" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkSilenceGenerator" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkSilenceGenerator" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkSilenceGenerator" PRIVATE "-fno-rtti")
  target_compile_options("AkSilenceGenerator" PRIVATE "-fno-exceptions")
  target_compile_options("AkSilenceGenerator" PRIVATE "-ffunction-sections")
  target_compile_options("AkSilenceGenerator" PRIVATE "-fdata-sections")
  target_compile_options("AkSilenceGenerator" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkSilenceGenerator" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkSilenceGenerator" PRIVATE
