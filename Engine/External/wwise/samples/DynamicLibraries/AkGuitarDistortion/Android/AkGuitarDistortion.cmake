add_library("AkGuitarDistortion" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkGuitarDistortion" PROPERTIES
    OUTPUT_NAME "AkGuitarDistortion"
  ...
  target_include_directories("AkGuitarDistortion" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkGuitarDistortion" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkGuitarDistortion" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkGuitarDistortion"
    "AkGuitarDistortionFX"
  )
  target_compile_options("AkGuitarDistortion" PRIVATE "-fPIC")
  target_compile_options("AkGuitarDistortion" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkGuitarDistortion" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkGuitarDistortion" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkGuitarDistortion" PRIVATE "-fno-rtti")
  target_compile_options("AkGuitarDistortion" PRIVATE "-fno-exceptions")
  target_compile_options("AkGuitarDistortion" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkGuitarDistortion" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkGuitarDistortion" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkGuitarDistortion" PRIVATE "-fno-rtti")
  target_compile_options("AkGuitarDistortion" PRIVATE "-fno-exceptions")
  target_compile_options("AkGuitarDistortion" PRIVATE "-ffunction-sections")
  target_compile_options("AkGuitarDistortion" PRIVATE "-fdata-sections")
  target_compile_options("AkGuitarDistortion" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkGuitarDistortion" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkGuitarDistortion" PRIVATE
