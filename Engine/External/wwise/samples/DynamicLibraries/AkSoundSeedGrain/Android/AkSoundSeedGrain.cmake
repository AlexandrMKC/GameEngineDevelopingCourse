add_library("AkSoundSeedGrain" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkSoundSeedGrain" PROPERTIES
    OUTPUT_NAME "AkSoundSeedGrain"
  ...
  target_include_directories("AkSoundSeedGrain" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkSoundSeedGrain" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkSoundSeedGrain" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkSoundSeedGrain"
    "AkSoundSeedGrainSource"
  )
  target_compile_options("AkSoundSeedGrain" PRIVATE "-fPIC")
  target_compile_options("AkSoundSeedGrain" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkSoundSeedGrain" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkSoundSeedGrain" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkSoundSeedGrain" PRIVATE "-fno-rtti")
  target_compile_options("AkSoundSeedGrain" PRIVATE "-fno-exceptions")
  target_compile_options("AkSoundSeedGrain" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkSoundSeedGrain" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkSoundSeedGrain" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkSoundSeedGrain" PRIVATE "-fno-rtti")
  target_compile_options("AkSoundSeedGrain" PRIVATE "-fno-exceptions")
  target_compile_options("AkSoundSeedGrain" PRIVATE "-ffunction-sections")
  target_compile_options("AkSoundSeedGrain" PRIVATE "-fdata-sections")
  target_compile_options("AkSoundSeedGrain" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkSoundSeedGrain" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkSoundSeedGrain" PRIVATE
