...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  ...
  target_include_directories("McDSP" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("McDSP" PRIVATE
    "_DEBUG"
  )
  target_link_directories("McDSP" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("McDSP"
    "McDSPFutzBoxFX"
    "McDSPLimiterFX"
  )
  target_compile_options("McDSP" PRIVATE "-fPIC")
  target_compile_options("McDSP" PRIVATE "-Wno-conversion-null")
  target_compile_options("McDSP" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("McDSP" PRIVATE "-fvisibility=hidden")
  target_compile_options("McDSP" PRIVATE "-fno-rtti")
  target_compile_options("McDSP" PRIVATE "-fno-exceptions")
  target_compile_options("McDSP" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("McDSP" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("McDSP" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("McDSP" PRIVATE "-fno-rtti")
  target_compile_options("McDSP" PRIVATE "-fno-exceptions")
  target_compile_options("McDSP" PRIVATE "-ffunction-sections")
  target_compile_options("McDSP" PRIVATE "-fdata-sections")
  target_compile_options("McDSP" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("McDSP" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("McDSP" PRIVATE
