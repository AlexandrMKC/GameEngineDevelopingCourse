add_library("AkFlanger" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkFlanger" PROPERTIES
    OUTPUT_NAME "AkFlanger"
  ...
  target_include_directories("AkFlanger" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkFlanger" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkFlanger" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkFlanger"
    "AkFlangerFX"
  )
  target_compile_options("AkFlanger" PRIVATE "-fPIC")
  target_compile_options("AkFlanger" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkFlanger" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkFlanger" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkFlanger" PRIVATE "-fno-rtti")
  target_compile_options("AkFlanger" PRIVATE "-fno-exceptions")
  target_compile_options("AkFlanger" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkFlanger" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkFlanger" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkFlanger" PRIVATE "-fno-rtti")
  target_compile_options("AkFlanger" PRIVATE "-fno-exceptions")
  target_compile_options("AkFlanger" PRIVATE "-ffunction-sections")
  target_compile_options("AkFlanger" PRIVATE "-fdata-sections")
  target_compile_options("AkFlanger" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkFlanger" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkFlanger" PRIVATE
