add_library("Ak3DAudioBedMixer" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("Ak3DAudioBedMixer" PROPERTIES
    OUTPUT_NAME "Ak3DAudioBedMixer"
  ...
  target_include_directories("Ak3DAudioBedMixer" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("Ak3DAudioBedMixer" PRIVATE
    "_DEBUG"
  )
  target_link_directories("Ak3DAudioBedMixer" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("Ak3DAudioBedMixer"
    "Ak3DAudioBedMixerFX"
  )
  target_compile_options("Ak3DAudioBedMixer" PRIVATE "-fPIC")
  target_compile_options("Ak3DAudioBedMixer" PRIVATE "-Wno-conversion-null")
  target_compile_options("Ak3DAudioBedMixer" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("Ak3DAudioBedMixer" PRIVATE "-fvisibility=hidden")
  target_compile_options("Ak3DAudioBedMixer" PRIVATE "-fno-rtti")
  target_compile_options("Ak3DAudioBedMixer" PRIVATE "-fno-exceptions")
  target_compile_options("Ak3DAudioBedMixer" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("Ak3DAudioBedMixer" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("Ak3DAudioBedMixer" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("Ak3DAudioBedMixer" PRIVATE "-fno-rtti")
  target_compile_options("Ak3DAudioBedMixer" PRIVATE "-fno-exceptions")
  target_compile_options("Ak3DAudioBedMixer" PRIVATE "-ffunction-sections")
  target_compile_options("Ak3DAudioBedMixer" PRIVATE "-fdata-sections")
  target_compile_options("Ak3DAudioBedMixer" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("Ak3DAudioBedMixer" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("Ak3DAudioBedMixer" PRIVATE
