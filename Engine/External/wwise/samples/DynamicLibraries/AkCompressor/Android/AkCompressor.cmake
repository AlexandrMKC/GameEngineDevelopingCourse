add_library("AkCompressor" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkCompressor" PROPERTIES
    OUTPUT_NAME "AkCompressor"
  ...
  target_include_directories("AkCompressor" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkCompressor" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkCompressor" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkCompressor"
    "AkCompressorFX"
  )
  target_compile_options("AkCompressor" PRIVATE "-fPIC")
  target_compile_options("AkCompressor" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkCompressor" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkCompressor" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkCompressor" PRIVATE "-fno-rtti")
  target_compile_options("AkCompressor" PRIVATE "-fno-exceptions")
  target_compile_options("AkCompressor" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkCompressor" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkCompressor" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkCompressor" PRIVATE "-fno-rtti")
  target_compile_options("AkCompressor" PRIVATE "-fno-exceptions")
  target_compile_options("AkCompressor" PRIVATE "-ffunction-sections")
  target_compile_options("AkCompressor" PRIVATE "-fdata-sections")
  target_compile_options("AkCompressor" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkCompressor" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkCompressor" PRIVATE
