add_library("AkSynthOne" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkSynthOne" PROPERTIES
    OUTPUT_NAME "AkSynthOne"
  ...
  target_include_directories("AkSynthOne" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkSynthOne" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkSynthOne" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkSynthOne"
    "AkSynthOneSource"
  )
  target_compile_options("AkSynthOne" PRIVATE "-fPIC")
  target_compile_options("AkSynthOne" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkSynthOne" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkSynthOne" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkSynthOne" PRIVATE "-fno-rtti")
  target_compile_options("AkSynthOne" PRIVATE "-fno-exceptions")
  target_compile_options("AkSynthOne" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkSynthOne" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkSynthOne" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkSynthOne" PRIVATE "-fno-rtti")
  target_compile_options("AkSynthOne" PRIVATE "-fno-exceptions")
  target_compile_options("AkSynthOne" PRIVATE "-ffunction-sections")
  target_compile_options("AkSynthOne" PRIVATE "-fdata-sections")
  target_compile_options("AkSynthOne" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkSynthOne" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkSynthOne" PRIVATE
