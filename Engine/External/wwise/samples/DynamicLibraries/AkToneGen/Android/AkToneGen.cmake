add_library("AkToneGen" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkToneGen" PROPERTIES
    OUTPUT_NAME "AkToneGen"
  ...
  target_include_directories("AkToneGen" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkToneGen" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkToneGen" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkToneGen"
    "AkToneSource"
  )
  target_compile_options("AkToneGen" PRIVATE "-fPIC")
  target_compile_options("AkToneGen" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkToneGen" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkToneGen" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkToneGen" PRIVATE "-fno-rtti")
  target_compile_options("AkToneGen" PRIVATE "-fno-exceptions")
  target_compile_options("AkToneGen" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkToneGen" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkToneGen" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkToneGen" PRIVATE "-fno-rtti")
  target_compile_options("AkToneGen" PRIVATE "-fno-exceptions")
  target_compile_options("AkToneGen" PRIVATE "-ffunction-sections")
  target_compile_options("AkToneGen" PRIVATE "-fdata-sections")
  target_compile_options("AkToneGen" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkToneGen" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkToneGen" PRIVATE
