...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  ...
  target_include_directories("AkMeter" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkMeter" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkMeter" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkMeter"
    "AkMeterFX"
  )
  target_compile_options("AkMeter" PRIVATE "-fPIC")
  target_compile_options("AkMeter" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkMeter" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkMeter" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkMeter" PRIVATE "-fno-rtti")
  target_compile_options("AkMeter" PRIVATE "-fno-exceptions")
  target_compile_options("AkMeter" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkMeter" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkMeter" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkMeter" PRIVATE "-fno-rtti")
  target_compile_options("AkMeter" PRIVATE "-fno-exceptions")
  target_compile_options("AkMeter" PRIVATE "-ffunction-sections")
  target_compile_options("AkMeter" PRIVATE "-fdata-sections")
  target_compile_options("AkMeter" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkMeter" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkMeter" PRIVATE
