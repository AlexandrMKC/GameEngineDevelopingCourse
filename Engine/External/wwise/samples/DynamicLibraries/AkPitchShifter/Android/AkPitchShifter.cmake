add_library("AkPitchShifter" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkPitchShifter" PROPERTIES
    OUTPUT_NAME "AkPitchShifter"
  ...
  target_include_directories("AkPitchShifter" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkPitchShifter" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkPitchShifter" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkPitchShifter"
    "AkPitchShifterFX"
  )
  target_compile_options("AkPitchShifter" PRIVATE "-fPIC")
  target_compile_options("AkPitchShifter" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkPitchShifter" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkPitchShifter" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkPitchShifter" PRIVATE "-fno-rtti")
  target_compile_options("AkPitchShifter" PRIVATE "-fno-exceptions")
  target_compile_options("AkPitchShifter" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkPitchShifter" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkPitchShifter" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkPitchShifter" PRIVATE "-fno-rtti")
  target_compile_options("AkPitchShifter" PRIVATE "-fno-exceptions")
  target_compile_options("AkPitchShifter" PRIVATE "-ffunction-sections")
  target_compile_options("AkPitchShifter" PRIVATE "-fdata-sections")
  target_compile_options("AkPitchShifter" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkPitchShifter" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkPitchShifter" PRIVATE
