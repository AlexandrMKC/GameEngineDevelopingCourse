add_library("AkSineTone" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkSineTone" PROPERTIES
    OUTPUT_NAME "AkSineTone"
  ...
  target_include_directories("AkSineTone" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkSineTone" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkSineTone" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkSineTone"
    "AkSineSource"
  )
  target_compile_options("AkSineTone" PRIVATE "-fPIC")
  target_compile_options("AkSineTone" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkSineTone" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkSineTone" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkSineTone" PRIVATE "-fno-rtti")
  target_compile_options("AkSineTone" PRIVATE "-fno-exceptions")
  target_compile_options("AkSineTone" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkSineTone" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkSineTone" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkSineTone" PRIVATE "-fno-rtti")
  target_compile_options("AkSineTone" PRIVATE "-fno-exceptions")
  target_compile_options("AkSineTone" PRIVATE "-ffunction-sections")
  target_compile_options("AkSineTone" PRIVATE "-fdata-sections")
  target_compile_options("AkSineTone" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkSineTone" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkSineTone" PRIVATE
