...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  ...
  target_include_directories("Auro" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("Auro" PRIVATE
    "_DEBUG"
  )
  target_link_directories("Auro" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("Auro"
    "AuroHeadphoneFX"
  )
  target_compile_options("Auro" PRIVATE "-fPIC")
  target_compile_options("Auro" PRIVATE "-Wno-conversion-null")
  target_compile_options("Auro" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("Auro" PRIVATE "-fvisibility=hidden")
  target_compile_options("Auro" PRIVATE "-fno-rtti")
  target_compile_options("Auro" PRIVATE "-fno-exceptions")
  target_compile_options("Auro" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("Auro" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("Auro" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("Auro" PRIVATE "-fno-rtti")
  target_compile_options("Auro" PRIVATE "-fno-exceptions")
  target_compile_options("Auro" PRIVATE "-ffunction-sections")
  target_compile_options("Auro" PRIVATE "-fdata-sections")
  target_compile_options("Auro" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("Auro" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("Auro" PRIVATE
