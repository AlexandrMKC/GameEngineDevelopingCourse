...
public:
	...
	void GetEventMedia(const WwiseMediaGlobalIdsMap& GlobalMap, WwiseMediaIdsMap& outMedias) const;
	void GetAllMedia(const WwiseMediaGlobalIdsMap& GlobalMap, WwiseMediaIdsMap& outMedias) const;
