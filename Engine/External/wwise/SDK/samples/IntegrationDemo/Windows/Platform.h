...
#if defined(AK_CPU_X86_64) // GameInput libraries are only available for x64, not x86 or arm
// Enables enumeration and availability of GameInput devices
#define INTDEMO_GAMEINPUT_AVAILABLE
#endif
...
// Uncomment to revert plug-in linkage static, instead of dynamic
// (don't forget you may need to adjust build dependencies to get updates to catch properly)
//#define INTDEMO_STATIC_LINK_PREMIUM_PLUGINS