...
{
	DemoCommandBufferCrowd* pg = new DemoCommandBufferCrowd(*m_pParentMenu);
...
{
	m_pParentMenu->StackPage(new PartnerPluginsMenu(*m_pParentMenu));
}
...
{
	m_pParentMenu->StackPage(new DemoChannels(*m_pParentMenu));
}
