add_library("AkDelayFX" STATIC
  "${CMAKE_CURRENT_LIST_DIR}/../AkDelayFX.cpp"
  "${CMAKE_CURRENT_LIST_DIR}/../AkDelayFXDSP.cpp"
  "${CMAKE_CURRENT_LIST_DIR}/../AkDelayFXParams.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkDelayFX" PROPERTIES
    OUTPUT_NAME "AkDelayFX"
  ...
  target_include_directories("AkDelayFX" PRIVATE
  ...
  target_compile_definitions("AkDelayFX" PRIVATE
    "_DEBUG"
  )
  target_compile_options("AkDelayFX" PRIVATE "-ffast-math")
  target_compile_options("AkDelayFX" PRIVATE "-fPIC")
  target_compile_options("AkDelayFX" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkDelayFX" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkDelayFX" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkDelayFX" PRIVATE "-fno-rtti")
  target_compile_options("AkDelayFX" PRIVATE "-fno-exceptions")
  target_compile_options("AkDelayFX" PRIVATE "-fno-omit-frame-pointer")
  if (MSVC)
    target_compile_options("AkDelayFX" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkDelayFX" PRIVATE "-fno-rtti")
  target_compile_options("AkDelayFX" PRIVATE "-fno-exceptions")
  target_compile_options("AkDelayFX" PRIVATE "-ffunction-sections")
  target_compile_options("AkDelayFX" PRIVATE "-fdata-sections")
  target_compile_options("AkDelayFX" PRIVATE "-fno-omit-frame-pointer")
  if (MSVC)
    target_compile_options("AkDelayFX" PRIVATE
      $<$<COMPILE_LANGUAGE:C>:/WX>
