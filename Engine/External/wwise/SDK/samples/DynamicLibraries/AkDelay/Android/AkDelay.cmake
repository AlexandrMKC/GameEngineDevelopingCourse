...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  ...
  target_include_directories("AkDelay" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkDelay" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkDelay" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkDelay"
    "AkDelayFX"
  )
  target_compile_options("AkDelay" PRIVATE "-fPIC")
  target_compile_options("AkDelay" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkDelay" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkDelay" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkDelay" PRIVATE "-fno-rtti")
  target_compile_options("AkDelay" PRIVATE "-fno-exceptions")
  target_compile_options("AkDelay" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkDelay" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkDelay" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkDelay" PRIVATE "-fno-rtti")
  target_compile_options("AkDelay" PRIVATE "-fno-exceptions")
  target_compile_options("AkDelay" PRIVATE "-ffunction-sections")
  target_compile_options("AkDelay" PRIVATE "-fdata-sections")
  target_compile_options("AkDelay" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkDelay" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkDelay" PRIVATE
