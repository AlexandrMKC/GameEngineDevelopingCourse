add_library("AkPeakLimiter" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkPeakLimiter" PROPERTIES
    OUTPUT_NAME "AkPeakLimiter"
  ...
  target_include_directories("AkPeakLimiter" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkPeakLimiter" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkPeakLimiter" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkPeakLimiter"
    "AkPeakLimiterFX"
  )
  target_compile_options("AkPeakLimiter" PRIVATE "-fPIC")
  target_compile_options("AkPeakLimiter" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkPeakLimiter" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkPeakLimiter" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkPeakLimiter" PRIVATE "-fno-rtti")
  target_compile_options("AkPeakLimiter" PRIVATE "-fno-exceptions")
  target_compile_options("AkPeakLimiter" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkPeakLimiter" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkPeakLimiter" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkPeakLimiter" PRIVATE "-fno-rtti")
  target_compile_options("AkPeakLimiter" PRIVATE "-fno-exceptions")
  target_compile_options("AkPeakLimiter" PRIVATE "-ffunction-sections")
  target_compile_options("AkPeakLimiter" PRIVATE "-fdata-sections")
  target_compile_options("AkPeakLimiter" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkPeakLimiter" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkPeakLimiter" PRIVATE
