add_library("MasteringSuite" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("MasteringSuite" PROPERTIES
    OUTPUT_NAME "MasteringSuite"
  ...
  target_include_directories("MasteringSuite" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("MasteringSuite" PRIVATE
    "_DEBUG"
  )
  target_link_directories("MasteringSuite" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("MasteringSuite"
    "MasteringSuiteFX"
  )
  target_compile_options("MasteringSuite" PRIVATE "-fPIC")
  target_compile_options("MasteringSuite" PRIVATE "-Wno-conversion-null")
  target_compile_options("MasteringSuite" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("MasteringSuite" PRIVATE "-fvisibility=hidden")
  target_compile_options("MasteringSuite" PRIVATE "-fno-rtti")
  target_compile_options("MasteringSuite" PRIVATE "-fno-exceptions")
  target_compile_options("MasteringSuite" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("MasteringSuite" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("MasteringSuite" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("MasteringSuite" PRIVATE "-fno-rtti")
  target_compile_options("MasteringSuite" PRIVATE "-fno-exceptions")
  target_compile_options("MasteringSuite" PRIVATE "-ffunction-sections")
  target_compile_options("MasteringSuite" PRIVATE "-fdata-sections")
  target_compile_options("MasteringSuite" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("MasteringSuite" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("MasteringSuite" PRIVATE
