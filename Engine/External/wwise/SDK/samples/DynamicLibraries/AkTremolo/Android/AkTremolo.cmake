add_library("AkTremolo" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkTremolo" PROPERTIES
    OUTPUT_NAME "AkTremolo"
  ...
  target_include_directories("AkTremolo" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkTremolo" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkTremolo" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkTremolo"
    "AkTremoloFX"
  )
  target_compile_options("AkTremolo" PRIVATE "-fPIC")
  target_compile_options("AkTremolo" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkTremolo" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkTremolo" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkTremolo" PRIVATE "-fno-rtti")
  target_compile_options("AkTremolo" PRIVATE "-fno-exceptions")
  target_compile_options("AkTremolo" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkTremolo" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkTremolo" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkTremolo" PRIVATE "-fno-rtti")
  target_compile_options("AkTremolo" PRIVATE "-fno-exceptions")
  target_compile_options("AkTremolo" PRIVATE "-ffunction-sections")
  target_compile_options("AkTremolo" PRIVATE "-fdata-sections")
  target_compile_options("AkTremolo" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkTremolo" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkTremolo" PRIVATE
