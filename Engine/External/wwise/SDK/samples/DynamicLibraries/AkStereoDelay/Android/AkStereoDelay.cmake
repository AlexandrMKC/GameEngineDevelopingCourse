add_library("AkStereoDelay" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkStereoDelay" PROPERTIES
    OUTPUT_NAME "AkStereoDelay"
  ...
  target_include_directories("AkStereoDelay" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkStereoDelay" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkStereoDelay" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkStereoDelay"
    "AkStereoDelayFX"
  )
  target_compile_options("AkStereoDelay" PRIVATE "-fPIC")
  target_compile_options("AkStereoDelay" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkStereoDelay" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkStereoDelay" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkStereoDelay" PRIVATE "-fno-rtti")
  target_compile_options("AkStereoDelay" PRIVATE "-fno-exceptions")
  target_compile_options("AkStereoDelay" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkStereoDelay" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkStereoDelay" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkStereoDelay" PRIVATE "-fno-rtti")
  target_compile_options("AkStereoDelay" PRIVATE "-fno-exceptions")
  target_compile_options("AkStereoDelay" PRIVATE "-ffunction-sections")
  target_compile_options("AkStereoDelay" PRIVATE "-fdata-sections")
  target_compile_options("AkStereoDelay" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkStereoDelay" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkStereoDelay" PRIVATE
