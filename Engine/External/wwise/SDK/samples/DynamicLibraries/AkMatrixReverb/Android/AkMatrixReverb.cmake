add_library("AkMatrixReverb" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkMatrixReverb" PROPERTIES
    OUTPUT_NAME "AkMatrixReverb"
  ...
  target_include_directories("AkMatrixReverb" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkMatrixReverb" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkMatrixReverb" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkMatrixReverb"
    "AkMatrixReverbFX"
  )
  target_compile_options("AkMatrixReverb" PRIVATE "-fPIC")
  target_compile_options("AkMatrixReverb" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkMatrixReverb" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkMatrixReverb" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkMatrixReverb" PRIVATE "-fno-rtti")
  target_compile_options("AkMatrixReverb" PRIVATE "-fno-exceptions")
  target_compile_options("AkMatrixReverb" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkMatrixReverb" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkMatrixReverb" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkMatrixReverb" PRIVATE "-fno-rtti")
  target_compile_options("AkMatrixReverb" PRIVATE "-fno-exceptions")
  target_compile_options("AkMatrixReverb" PRIVATE "-ffunction-sections")
  target_compile_options("AkMatrixReverb" PRIVATE "-fdata-sections")
  target_compile_options("AkMatrixReverb" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkMatrixReverb" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkMatrixReverb" PRIVATE
