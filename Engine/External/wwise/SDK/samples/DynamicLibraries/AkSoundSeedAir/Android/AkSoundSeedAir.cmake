add_library("AkSoundSeedAir" SHARED
  "${CMAKE_CURRENT_LIST_DIR}/../InitPlugins.cpp"
)
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Debug)
  set_target_properties("AkSoundSeedAir" PROPERTIES
    OUTPUT_NAME "AkSoundSeedAir"
  ...
  target_include_directories("AkSoundSeedAir" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../include"
  )
  target_compile_definitions("AkSoundSeedAir" PRIVATE
    "_DEBUG"
  )
  target_link_directories("AkSoundSeedAir" PRIVATE
    "${CMAKE_CURRENT_LIST_DIR}/../../../../Android_armeabi-v7a/Debug/lib"
  )
  target_link_libraries("AkSoundSeedAir"
    "AkSoundSeedWindSource"
    "AkSoundSeedWooshSource"
  )
  target_compile_options("AkSoundSeedAir" PRIVATE "-fPIC")
  target_compile_options("AkSoundSeedAir" PRIVATE "-Wno-conversion-null")
  target_compile_options("AkSoundSeedAir" PRIVATE "-Wno-deprecated-declarations")
  target_compile_options("AkSoundSeedAir" PRIVATE "-fvisibility=hidden")
  target_compile_options("AkSoundSeedAir" PRIVATE "-fno-rtti")
  target_compile_options("AkSoundSeedAir" PRIVATE "-fno-exceptions")
  target_compile_options("AkSoundSeedAir" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkSoundSeedAir" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkSoundSeedAir" PRIVATE
...
if(CMAKE_BUILD_TYPE STREQUAL armeabi-v7a-Profile)
  ...
  target_compile_options("AkSoundSeedAir" PRIVATE "-fno-rtti")
  target_compile_options("AkSoundSeedAir" PRIVATE "-fno-exceptions")
  target_compile_options("AkSoundSeedAir" PRIVATE "-ffunction-sections")
  target_compile_options("AkSoundSeedAir" PRIVATE "-fdata-sections")
  target_compile_options("AkSoundSeedAir" PRIVATE "-fno-omit-frame-pointer")
  set_target_properties("AkSoundSeedAir" PROPERTIES LINK_FLAGS "-Wl,--as-needed,-z,max-page-size=16384 -Wl,--export-dynamic ")
  if (MSVC)
    target_compile_options("AkSoundSeedAir" PRIVATE
